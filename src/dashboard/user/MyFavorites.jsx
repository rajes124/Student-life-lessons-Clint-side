    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 py-12 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-rose-600 mb-4">
            My Favorite Lessons
          </h1>
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Your personal collection of wisdom and inspiration ❤️
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto mb-12">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-16 pr-8 py-5 text-lg border-0 rounded-2xl shadow-xl focus:ring-4 focus:ring-pink-300 focus:outline-none bg-white"
            />
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {filteredFavorites.map((lesson, index) => {
              ...
              return (
                <div
                  key={lesson._id}
                  className="group relative bg-white rounded-3xl shadow-2xl overflow-hidden transition-all duration-700 hover:shadow-3xl hover:-translate-y-6"
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  {/* Premium Badge */}
                  {isPremium && (
                    <div className="absolute top-4 right-4 z-10 bg-gradient-to-r from-amber-400 to-yellow-500 text-white px-4 py-2 rounded-full text-sm font-bold flex items-center gap-2 shadow-lg">
                  ...
                  {/* Content */}
                  <div className="p-8">
                    <h3 className="text-2xl font-bold text-indigo-800 mb-4 line-clamp-2">
                      {lesson.title}
                    </h3>
...
<div className="flex justify-between items-center gap-4 mt-6">
  <Link
    ...
    className="flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-6 py-3 rounded-xl font-semibold text-sm shadow-md hover:shadow-lg transition-all duration-300"
  >
  ...
  <button
    ...
    className="flex items-center gap-2 bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 text-white px-5 py-3 rounded-xl font-semibold text-sm shadow-md hover:shadow-lg transition-all duration-300"
  >
