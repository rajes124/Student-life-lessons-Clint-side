  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 md:py-16 overflow-hidden">
      ...
      <div className="text-center mb-12" data-aos="fade-down">
        ...
        <p className="text-slate-600 font-bold text-lg max-w-lg mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 order-2 lg:order-1" data-aos="fade-right">
          <form onSubmit={handleSubmit} className="space-y-8 bg-white p-6 md:p-10 rounded-[2.5rem] shadow-2xl border border-slate-200">
            
            {/* Title Input */}
            <div className="space-y-3">
              <label className="text-sm font-black uppercase tracking-widest text-slate-700 ml-2 flex items-center gap-2">
              ...
              <input
                ...
                className={`w-full px-6 py-5 rounded-2xl bg-slate-50 border-2 transition-all font-bold text-slate-900 text-lg placeholder-slate-400 ${isFocused === 'title' ? 'border-indigo-600 bg-white ring-4 ring-indigo-50 shadow-inner' : 'border-slate-100'}`}
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                className={`w-full px-6 py-5 rounded-2xl bg-slate-50 border-2 transition-all font-semibold text-slate-800 text-lg placeholder-slate-400 leading-relaxed ${isFocused === 'desc' ? 'border-indigo-600 bg-white ring-4 ring-indigo-50 shadow-inner' : 'border-slate-100'}`}
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  <select 
                    ...
                    className="w-full px-6 py-5 rounded-2xl bg-slate-50 border-2 border-slate-100 focus:border-indigo-600 font-bold text-slate-800 appearance-none shadow-sm cursor-pointer"
                  >
            ...
            <div className="space-y-3">
                ...
                <input
                    ...
                    className="w-full px-6 py-5 rounded-2xl bg-slate-50 border-2 border-slate-100 focus:border-indigo-600 font-bold text-slate-800 shadow-sm"
        ...
        <div className="lg:col-span-4 order-1 lg:order-2" data-aos="fade-left">
            <div className="sticky top-10 space-y-6">
                <div className="bg-white border-2 border-slate-900 p-3 rounded-[2.5rem] shadow-[15px_15px_0px_0px_rgba(79,70,229,1)] overflow-hidden">
                    <div className="relative h-72 rounded-[2rem] overflow-hidden bg-slate-200 border border-slate-100">
                        {imageURL ? (
                             <img src={imageURL} className="w-full h-full object-cover" alt="Preview" />
                        ) : (
                             <div className="w-full h-full flex flex-col items-center justify-center text-slate-400 gap-2">
                                <ImageIcon className="w-10 h-10 opacity-20" />
                                <span className="text-xs font-black tracking-widest uppercase">No Image URL Provided</span>
                             </div>
                        )}
                    ...
                    <div className="p-6">
                        <h3 className="text-2xl font-black text-slate-900 mb-3 line-clamp-2 leading-tight uppercase tracking-tighter">{title || "Your Awesome Title"}</h3>
                        <p className="text-slate-600 text-sm line-clamp-4 mb-8 font-bold leading-relaxed border-l-4 border-indigo-100 pl-4 italic">
