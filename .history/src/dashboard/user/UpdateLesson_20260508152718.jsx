      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="relative">
          ...
          <input
            ...
            required
            className="w-full px-5 py-4 border border-base-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all text-lg placeholder:text-base-content/40 shadow-sm bg-base-100 text-base-content"
        ...
        <div className="relative">
          ...
          <textarea
            ...
            required
            rows="8"
            className="w-full px-5 py-4 border border-base-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all text-lg placeholder:text-base-content/40 shadow-sm resize-y bg-base-100 text-base-content"
