          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
            {filteredFavorites.map((lesson, index) => {
              ...
              return (
                <div
                  key={lesson._id}
                  className="group relative bg-white rounded-3xl shadow-2xl overflow-hidden transition-all duration-500 hover:shadow-3xl hover:-translate-y-6 border border-gray-100 hover:border-pink-300"
