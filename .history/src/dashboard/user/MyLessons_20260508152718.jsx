    ...
    <div className="max-w-7xl mx-auto px-4 py-6 md:py-10 md:px-8">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 md:mb-12">
        <div className="text-center md:text-left">
          <h2 className="text-3xl md:text-6xl font-black text-base-100 tracking-tight flex items-center justify-center md:justify-start gap-4">
            My <span className="text-indigo-600 underline decoration-indigo-100 underline-offset-8">Lessons</span>
          </h2>
          <p className="text-base-content/60 font-bold mt-4 flex items-center justify-center md:justify-start gap-2 text-xs md:text-sm uppercase tracking-widest">
          ...
          <table className="w-full text-left border-separate border-spacing-0">
            <thead>
              <tr className="bg-base-200/80">
                <th className="p-4 md:p-6 text-[10px] font-black uppercase tracking-widest text-base-content/60 border-b border-base-300">Lesson & Details</th>
                <th className="p-6 text-[10px] font-black uppercase tracking-widest text-base-content/60 border-b border-base-300 hidden lg:table-cell">Category</th>
                <th className="p-4 md:p-6 text-[10px] font-black uppercase tracking-widest text-base-content/60 border-b border-base-300">Status & Access</th>
                <th className="p-6 text-[10px] font-black uppercase tracking-widest text-base-content/60 border-b border-base-300 hidden md:table-cell text-center">Stats</th>
                <th className="p-4 md:p-6 text-[10px] font-black uppercase tracking-widest text-base-content/60 border-b border-base-300 text-right">Actions</th>
              </tr>
            </thead>
                ...
                <tr key={lesson._id} className="group hover:bg-indigo-50/40 transition-all">
                  ...
                  <td className="p-4 md:p-6">
                    <div className="flex items-center gap-3 md:gap-5">
                      ...
                      <div className="min-w-0 max-w-[120px] sm:max-w-xs lg:max-w-md">
                        ...
                        <div className="flex items-center gap-2 mt-1 text-[10px] text-base-content/60 font-bold">
                  ...
                  <td className="p-4 md:p-6 text-right">
                    <div className="flex items-center justify-end gap-1.5 md:gap-3">
                      <Link to={`/lessons/${lesson._id}`} className="p-2 md:p-3 bg-base-100 text-base-content/60 rounded-xl hover:bg-indigo-600 hover:text-white transition-all shadow-sm" title="View"><Eye className="w-4 h-4 md:w-5 md:h-5" /></Link>
                      <Link to={`/dashboard/update-lesson/${lesson._id}`} className="p-2 md:p-3 bg-base-100 text-base-content/60 rounded-xl hover:bg-amber-500 hover:text-white transition-all shadow-sm" title="Edit"><Edit className="w-4 h-4 md:w-5 md:h-5" /></Link>
                      <button onClick={() => handleDelete(lesson._id, lesson.title)} className="p-2 md:p-3 bg-base-100 text-base-content/60 rounded-xl hover:bg-red-600 hover:text-white transition-all shadow-sm" title="Delete"><Trash2 className="w-4 h-4 md:w-5 md:h-5" /></button>
                    </div>
                  </td>
      ...
      <div className="mt-8 md:mt-12 flex flex-col sm:flex-row items-center justify-between text-base-content/60 text-[10px] md:text-xs font-black uppercase tracking-[0.2em] px-4 md:px-8 gap-4">
