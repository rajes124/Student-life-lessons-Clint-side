          ...
          <form onSubmit={handleSubmit} className="space-y-8 bg-base-100 p-6 md:p-10 rounded-[2.5rem] shadow-2xl border border-base-300">
            ...
            <div className="space-y-3">
              ...
              <input
                ...
                className={`w-full px-6 py-5 rounded-2xl bg-base-100 border-2 transition-all font-bold text-base-content text-lg placeholder:text-base-content/40 ${isFocused === 'title' ? 'border-indigo-600 ring-4 ring-indigo-600/20 shadow-inner' : 'border-base-300'}`}
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                className={`w-full px-6 py-5 rounded-2xl bg-base-100 border-2 transition-all font-semibold text-base-content text-lg placeholder:text-base-content/40 leading-relaxed ${isFocused === 'desc' ? 'border-indigo-600 ring-4 ring-indigo-600/20 shadow-inner' : 'border-base-300'}`}
