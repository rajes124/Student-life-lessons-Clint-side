  ...
  return (
    <div className="min-h-screen bg-base-100 py-8 md:py-16 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="relative z-10 text-center md:text-left flex flex-col md:flex-row items-center gap-8 md:gap-16">
            <div className="flex-1">
              ...
              <p className="text-base-content/70 text-lg md:text-xl font-medium max-w-2xl leading-relaxed mb-8">
            ...
            <div className="hidden lg:flex flex-col items-center p-8 bg-base-200 rounded-[3rem] border border-base-100 shadow-inner">
               <div className="w-32 h-32 rounded-[2.5rem] overflow-hidden border-4 border-base-100 shadow-2xl mb-4">
                  <img 
               ...
               <p className="font-black text-base-content uppercase tracking-tighter text-center">{currentUser?.displayName}</p>
               <p className="text-[10px] text-base-content/60 font-bold uppercase tracking-widest mt-1 italic">{currentUser?.email}</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
          {actions.map((item, idx) => (
            <Link
              ...
              className="group relative bg-base-100 rounded-[2.5rem] p-8 md:p-10 border border-base-300 shadow-[0_20px_50px_rgba(0,0,0,0.03)] hover:shadow-[0_40px_80px_rgba(0,0,0,0.08)] transition-all duration-500 hover:-translate-y-4 overflow-hidden flex flex-col items-center text-center"
            >
              ...
              <div className="relative z-10">
                <h3 className={`text-2xl md:text-3xl font-black text-base-content mb-4 tracking-tighter group-hover:text-${item.color}-600 transition-colors`}>
                  {item.title}
                </h3>
                <p className="text-base-content/70 font-medium leading-relaxed mb-6">
                  {item.desc}
                </p>
                <div className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-base-content/50 group-hover:text-base-content transition-colors">
          ...
          {!userData?.isPremium && (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <span className="bg-base-100 text-primary px-8 py-3 rounded-xl font-black text-xs uppercase tracking-widest shadow-xl group-hover:bg-base-content group-hover:text-base-100 transition-all">
                  Explore Plans
                </span>
              </div>
            </Link>
        ...
        {/* --- Minimalist Footer --- */}
        <div 
          className="mt-20 py-10 border-t border-base-200 flex flex-col md:flex-row justify-between items-center gap-6"
          data-aos="fade-up"
        >
          <div className="flex items-center gap-6 text-[10px] font-black text-base-content/60 uppercase tracking-[0.3em]">
