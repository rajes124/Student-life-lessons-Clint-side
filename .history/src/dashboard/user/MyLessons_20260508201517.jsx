  ...
  if (loading) {
    return (
      <div className="min-h-[80vh] flex flex-col items-center justify-center space-y-4 px-4">
        ...
        <p className="text-sm md:text-xl font-black text-base-content/60 tracking-tighter uppercase text-center">Syncing Insights...</p>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-[70vh] flex items-center justify-center p-4">
        <div className="text-center group w-full max-w-md">
          ...
          <p className="text-base-content/60 mb-8 px-4 font-bold text-sm md:text-base">Your digital archive is waiting for its first spark of wisdom.</p>
          <Link
...
<p className="text-[11px] text-base-content/60 font-bold italic pl-1">Tone: {lesson.emotionalTone}</p>
                    </div>
                  </td>
