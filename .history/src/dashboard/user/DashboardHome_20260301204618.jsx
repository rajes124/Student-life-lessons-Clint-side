...
const DashboardHome = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] py-8 md:py-16 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        
        {/* --- Hero Welcome Section --- */}
        <div 
          className="relative overflow-hidden bg-white rounded-[2.5rem] md:rounded-[4rem] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.05)] border border-slate-100 p-8 md:p-20 mb-12 md:mb-20"
          data-aos="fade-down"
        >
          {/* Abstract Background Shapes */}
          <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 w-64 md:w-96 h-64 md:h-96 bg-indigo-50 rounded-full blur-3xl opacity-50"></div>
          <div className="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/4 w-64 md:w-96 h-64 md:h-96 bg-purple-50 rounded-full blur-3xl opacity-50"></div>
          ...
          <div className="relative z-10 text-center md:text-left flex flex-col md:flex-row items-center gap-8 md:gap-16">
            <div className="flex-1">
              ...
              {userData?.isPremium ? (
                <div className="inline-flex items-center gap-3 bg-slate-900 text-amber-400 px-6 py-3 rounded-2xl shadow-xl border border-white/10 animate-pulse">
