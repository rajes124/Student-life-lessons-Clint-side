  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 md:py-16 overflow-hidden">
      ...
      <div className="text-center mb-12" data-aos="fade-down">
        ...
        <h2 className="text-5xl md:text-7xl font-black text-base-content tracking-tighter mb-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-8 bg-base-100 p-6 md:p-10 rounded-[2.5rem] shadow-2xl border border-base-300">
            ...
            <div className="space-y-3">
              ...
              <input
                ...
                className={`w-full px-6 py-5 rounded-2xl bg-base-200 border-2 transition-all font-bold text-base-content text-lg placeholder:text-base-content/40 ${isFocused === 'title' ? 'border-indigo-600 bg-base-100 ring-4 ring-indigo-50 shadow-inner' : 'border-base-300'}`}
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                className={`w-full px-6 py-5 rounded-2xl bg-base-200 border-2 transition-all font-semibold text-base-content text-lg placeholder:text-base-content/40 leading-relaxed ${isFocused === 'desc' ? 'border-indigo-600 bg-base-100 ring-4 ring-indigo-50 shadow-inner' : 'border-base-300'}`}
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  <select 
                    ...
                    className="w-full px-6 py-5 rounded-2xl bg-base-200 border-2 border-base-300 focus:border-indigo-600 font-bold text-base-content appearance-none shadow-sm cursor-pointer"
                  >
            ...
            <div className="space-y-3">
                ...
                <input
                    ...
                    className="w-full px-6 py-5 rounded-2xl bg-base-200 border-2 border-base-300 focus:border-indigo-600 font-bold text-base-content shadow-sm"
                  ...
                  <div className="flex bg-slate-800 p-1.5 rounded-2xl">
                    {['Public', 'Private'].map(v => (
                      <button
                        ...
                        className={`flex-1 py-4 rounded-xl text-sm font-black transition-all duration-300 ${visibility === v ? 'bg-indigo-600 text-white shadow-lg' : 'text-base-content/70 hover:text-base-content'}`}
                      >
            ...
            <div className="sticky top-10 space-y-6">
                <div className="bg-base-100 border-2 border-base-300 p-3 rounded-[2.5rem] shadow-[15px_15px_0px_0px_rgba(79,70,229,1)] overflow-hidden">
                    ...
                    <div className="p-6">
                        ...
                        <p className="text-base-content/70 text-sm line-clamp-4 mb-8 font-bold leading-relaxed border-l-4 border-indigo-100 pl-4 italic">
                            {description || "Start writing to see how your insight will appear to your readers..."}
                        </p>
                        <div className="flex items-center justify-between pt-6 border-t-2 border-base-200">
