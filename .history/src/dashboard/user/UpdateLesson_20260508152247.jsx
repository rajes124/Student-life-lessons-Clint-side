...
const UpdateLesson = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-base-100">
        <div className="text-center">
          ...
          <p className="text-3xl font-bold text-base-content">Loading lesson data...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 lg:p-10 bg-base-100 rounded-3xl shadow-2xl mt-10 border border-base-300">
      <div className="flex items-center gap-4 mb-10">
        <button
          onClick={() => navigate("/dashboard/my-lessons")}
          className="p-3 bg-base-200 hover:bg-base-300 rounded-full transition"
        >
          <ArrowLeft className="w-6 h-6 text-base-content/70" />
        </button>
        <h2 className="text-4xl md:text-5xl font-bold text-base-content flex items-center gap-3">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="relative">
          <label className="block text-lg font-medium text-base-content mb-2 flex items-center gap-2">
          ...
          <input
            ...
            required
            className="w-full px-5 py-4 border border-base-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all text-lg text-base-content placeholder:text-base-content/40 shadow-sm"
        ...
        <div className="relative">
          ...
          <textarea
            ...
            required
            rows="8"
            className="w-full px-5 py-4 border border-base-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all text-lg text-base-content placeholder:text-base-content/40 shadow-sm resize-y"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="relative">
            ...
            <select
              ...
              className="w-full px-5 py-4 border border-base-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all text-lg text-base-content shadow-sm"
            >
              {categories.map((cat) => (
          ...
          <div className="relative">
            ...
            <select
              ...
              className={`w-full px-5 py-4 border rounded-xl focus:ring-2 transition-all text-lg shadow-sm ${
                !userData?.isPremium
                  ? "bg-base-200 cursor-not-allowed border-base-300"
                  : "border-base-300 focus:ring-indigo-500 focus:border-transparent"
              } text-base-content`}
            >
        ...
        <div className="flex flex-col sm:flex-row justify-end gap-4 pt-8">
          <button
            type="button"
            onClick={() => navigate("/dashboard/my-lessons")}
            className="px-8 py-4 bg-base-200 hover:bg-base-300 text-base-content font-bold rounded-xl transition shadow-md"
          >
            Cancel
          </button>
