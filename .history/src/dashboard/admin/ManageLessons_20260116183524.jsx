        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {lessons.map((lesson) => (
            ...
            >
              ...
              {/* Action Buttons - টেক্সট ঠিক করা + icon gap বাড়ানো */}
              <div className="p-5 bg-gray-50 border-t border-gray-100 flex gap-4">
                <button
                  onClick={() => handleFeatureToggle(lesson._id, lesson.isFeatured)}
                  className={`flex-1 py-3 px-4 rounded-xl font-semibold text-base transition-all flex items-center justify-center gap-2 shadow-sm min-w-0 ${
                    lesson.isFeatured
                ...
                <button
                  ...
                  className="flex-1 py-3 px-4 bg-red-600 hover:bg-red-700 text-white rounded-xl font-semibold text-base transition-all flex items-center justify-center gap-2 shadow-sm min-w-0"
                >
