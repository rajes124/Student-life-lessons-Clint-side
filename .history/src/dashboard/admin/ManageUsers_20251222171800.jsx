...
const ManageUsers = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-indigo-800 mb-8 flex items-center gap-3">
          ...
          <table className="w-full">
            <thead className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-lg font-bold">Premium</th>
