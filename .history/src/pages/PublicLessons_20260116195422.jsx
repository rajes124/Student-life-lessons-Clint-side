        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {lessons.map((lesson) => {
            ...
            return (
              <motion.div
                key={lesson._id}
                className="relative h-full perspective-1000" // 3D effect-এর জন্য perspective
                whileHover={{
                  scale: isPremiumLocked ? 1 : 1.04,
                  rotateX: isPremiumLocked ? 0 : 4,
                  rotateY: isPremiumLocked ? 0 : 4,
              ...
              >
                {/* Premium Lock Overlay – auto up-down bounce */}
                {isPremiumLocked && (
                  <div className="absolute inset-0 z-30 bg-black/70 backdrop-blur-sm rounded-2xl flex flex-col items-center justify-center text-white px-4">
                    <motion.div
                      animate={{
                        y: [-8, 8, -8], // up-down bounce
                        scale: [1, 1.1, 1],
                      }}
                      transition={{
                        duration: 2,
                    ...
                    >
                      <Lock className="w-14 h-14 mb-4 text-amber-400 drop-shadow-lg" />
                    </motion.div>

                    <p className="text-xl font-bold mb-3 drop-shadow-md">Premium Lesson</p>
                    <p className="text-base text-gray-200 mb-6 text-center drop-shadow">
