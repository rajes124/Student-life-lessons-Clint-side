...
const Pricing = () => {
  ...
  if (!user) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-purple-50 px-6">
        <div className="text-center bg-white rounded-3xl shadow-2xl p-10 sm:p-16 max-w-lg w-full">
          ...
          <Link to="/login">
            <button className="px-10 py-4 sm:px-12 sm:py-5 bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-lg sm:text-xl font-bold rounded-full shadow-2xl hover:scale-110 transition-all duration-500">
              Go to Login
            </button>
          </Link>
        </div>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-orange-50 px-6">
        <div className="text-center bg-white rounded-3xl shadow-2xl p-10 sm:p-16 max-w-lg w-full">
          ...
          <p className="text-xs sm:text-sm text-gray-500 mb-8 break-all">
  ...
  if (dbUser.isPremium) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-100 flex items-center justify-center px-6">
        <div className="text-center bg-white rounded-3xl shadow-2xl p-12 sm:p-20 max-w-xl w-full">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 py-12 sm:py-16 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
              ...
              <tbody>
                {features.map((row, i) => (
                  <tr key={i} className={i % 2 === 0 ? "bg-gray-50" : "bg-white"}>
                    <td className="p-4 sm:p-6 text-gray-800 font-medium text-base sm:text-lg">{row.feature}</td>
                    <td className="p-4 sm:p-6 text-center text-gray-600 font-semibold text-base sm:text-lg">{row.free}</td>
                    <td className="p-4 sm:p-6 text-center text-emerald-600 font-bold text-base sm:text-lg">{row.premium}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="bg-gradient-to-r from-indigo-100 to-purple-100 p-10 sm:p-16 text-center">
            ...
            <h2 className="text-5xl sm:text-6xl font-extrabold text-indigo-700 mb-4">
              ৳1500 <span className="text-2xl sm:text-3xl text-gray-600">($15 USD - Test)</span>
            </h2>
            <p className="text-lg sm:text-xl text-gray-600 mb-8 sm:mb-10">Lifetime Access • No Subscription • Instant Activation</p>

            {/* Premium Button - Responsive */}
            <button
              onClick={handleUpgrade}
              className="group relative inline-flex flex-col sm:flex-row items-center gap-4 sm:gap-6 bg-gradient-to-r from-white via-gray-50 to-white text-[#03373D] px-10 py-6 sm:px-16 sm:py-7 rounded-3xl text-2xl sm:text-3xl md:text-4xl font-extrabold shadow-2xl hover:shadow-[0_0_60px_rgba(79,70,229,0.6)] hover:scale-105 sm:hover:scale-110 transition-all duration-700 transform overflow-hidden border-4 border-indigo-400/30 w-full sm:w-auto"
            >
              {/* Left Icons */}
              <div className="flex items-center gap-3 sm:gap-4">
                <Gem className="w-9 h-9 sm:w-12 sm:h-12 text-indigo-600 group-hover:text-indigo-700 group-hover:scale-125 transition-all duration-500" />
                <Crown className="w-8 h-8 sm:w-11 sm:h-11 text-yellow-500 group-hover:scale-150 group-hover:rotate-12 transition-all duration-700" />
              </div>
              ...
              {/* Right Icons */}
              <div className="flex items-center gap-3 sm:gap-4">
                <Flame className="w-8 h-8 sm:w-11 sm:h-11 text-orange-500 group-hover:translate-y-[-10px] group-hover:rotate-[-15deg] transition-all duration-700" />
                <Trophy className="w-9 h-9 sm:w-12 sm:h-12 text-yellow-600 group-hover:rotate-180 group-hover:scale-125 transition-all duration-1000" />
                <Rocket className="w-9 h-9 sm:w-12 sm:h-12 text-pink-500 group-hover:translate-x-3 group-hover:-translate-y-3 transition-all duration-700" />
              </div>
