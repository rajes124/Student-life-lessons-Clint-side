...
const Home = () => {
  return (
    <div className="bg-base-100 min-h-screen">
      ...
      {/* 4. Community Impact */}
      <section
        className="py-16 sm:py-20 lg:py-24 bg-gradient-to-b from-slate-50/70 to-white"
        data-aos="fade-up"
        data-aos-delay="400"
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-14 lg:mb-16">
            <h2
              className="text-3xl sm:text-4xl lg:text-5xl font-extrabold bg-gradient-to-r from-indigo-600 via-violet-600 to-purple-600 bg-clip-text text-transparent mb-4"
              data-aos="zoom-in"
              data-aos-delay="150"
            >
              Community Impact
            </h2>
            <p className="text-base sm:text-lg text-slate-600 max-w-3xl mx-auto" data-aos="fade-up" data-aos-delay="250">
