          ...
          {benefits.map((benefit, index) => (
            ...
            >
              ...
              <div className="p-5 sm:p-6 flex flex-col flex-grow text-center">
                ...
                {/* নতুন Discover বাটন – ক্লিক করলে কিছু হবে না, শুধু hover effect */}
                <div className="
                  mt-auto inline-flex items-center justify-center gap-2 
                  px-5 py-2.5 sm:px-6 sm:py-3 
                  bg-gradient-to-r from-indigo-50 to-purple-50 
                  text-indigo-700 font-medium text-sm sm:text-base 
                  rounded-lg shadow-sm 
                  cursor-pointer 
                  group-hover:bg-gradient-to-r group-hover:from-indigo-100 group-hover:to-purple-100 
                  group-hover:text-indigo-800 
                  transition-all duration-300 hover:shadow-md hover:scale-[1.03]
                ">
                  Discover more
                  <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 transition-transform group-hover:translate-x-2 group-hover:text-indigo-800" />
                </div>
              </div>
            </div>
          ))}
