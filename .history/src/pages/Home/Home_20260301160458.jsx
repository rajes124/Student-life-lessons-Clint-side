...
const Home = () => {
  return (
    <div className="bg-[#F8FAFC] min-h-screen">
      {/* 1. Hero Slider – fade + zoom effect */}
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <h2
              className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-800 mb-10"
              data-aos="zoom-in"
              data-aos-delay="100"
            >
      ...
      {/* 5. Explore Topics (no links, just cards) */}
      <section
        className="bg-white py-16 sm:py-20 lg:py-24"
        data-aos="fade-up"
        data-aos-delay="500"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2
            className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-12 md:mb-16 text-gray-800"
            data-aos="fade-down"
            data-aos-delay="200"
          >
            Explore Topics
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {[
              ...
              <div
                key={i}
                className={`group bg-gray-50 rounded-xl p-8 text-center hover:shadow-xl hover:-translate-y-2 transition-all duration-300 border border-gray-200 hover:border-${cat.color}-300 cursor-default`}
                data-aos="zoom-in-up"
                data-aos-delay={`${i * 120 + 300}`}
              >
                <cat.icon
                  className={`w-12 h-12 mx-auto mb-6 text-${cat.color}-600 group-hover:text-${cat.color}-700 transition`}
                />
