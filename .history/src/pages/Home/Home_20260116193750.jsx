        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {[
              ...
              <Link
                key={i}
                to={`/lessons?category=${cat.title.toLowerCase().replace(" ", "-")}`}
                className="group bg-gray-50 rounded-xl p-8 text-center hover:shadow-xl hover:-translate-y-2 transition-all duration-300 border border-gray-200 hover:border-indigo-300"
              >
