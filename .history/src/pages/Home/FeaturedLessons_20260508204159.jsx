...
const FeaturedLessons = () => {
  ...
  return (
    <section className="py-16 md:py-20 lg:py-24 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
      <div className="pointer-events-none absolute -left-16 top-10 w-44 h-44 sm:w-72 sm:h-72 rounded-full bg-indigo-500/15 blur-3xl opacity-90 animate-blob"></div>
      <div className="pointer-events-none absolute right-0 top-24 w-40 h-40 sm:w-60 sm:h-60 rounded-full bg-fuchsia-400/10 blur-3xl opacity-80 animate-blob-slow"></div>
      <div className="pointer-events-none hidden lg:block absolute left-1/2 bottom-0 -translate-x-1/2 w-72 h-72 xl:w-[34rem] xl:h-[34rem] rounded-full bg-gradient-to-r from-indigo-500/10 via-purple-500/5 to-transparent blur-3xl opacity-60"></div>
      ...
      <style jsx global>{`
        @keyframes blobFloat { 0%, 100% { transform: translateY(0px) scale(1); } 50% { transform: translateY(-18px) scale(1.04); } }
        @keyframes blobFloatSlow { 0%, 100% { transform: translateY(0px) scale(1); } 50% { transform: translateY(-10px) scale(1.03); } }
        .animate-blob { animation: blobFloat 8s ease-in-out infinite; }
        .animate-blob-slow { animation: blobFloatSlow 10s ease-in-out infinite; }
        .animate-pulse-slower { animation: pulse 5s ease-in-out infinite; }
