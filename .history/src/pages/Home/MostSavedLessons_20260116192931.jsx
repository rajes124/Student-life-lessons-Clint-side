  ...
  useEffect(() => {
    const fetchMostSaved = async () => {
      try {
        ...
        // Fallback data (kept your original fallback)
        setLessons([
          {
            _id: "1",
        ...
        {lessons.map((lesson, index) => {
          ...
          return (
            ...
            >
              ...
              {/* Card Content */}
              <div className={`flex flex-col flex-grow ${isPremium ? "blur-sm pointer-events-none" : ""}`}>
                {/* Image */}
                ...
                <div className="p-5 flex flex-col flex-grow">
                  ...
                  <Link
                    ...
                    className="mt-auto inline-flex items-center justify-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg shadow transition-all duration-300"
                  >
                    Read More
