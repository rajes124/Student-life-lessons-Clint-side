...
const Home = () => {
  return (
    <div className="bg-slate-50/70 min-h-screen">
      {/* Hero – full bleed */}
      <div data-aos="fade" data-aos-duration="1400">
        <HeroSlider />
      </div>

      {/* Featured Lessons – elevated section */}
      <section className="relative -mt-16 sm:-mt-24 lg:-mt-32 z-10 pb-16 sm:pb-20 lg:pb-28">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div
            className="bg-white/95 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-xl shadow-slate-200/70 border border-slate-100"
            data-aos="fade-up"
            data-aos-delay="250"
          >
      ...
      {/* Why Share – clean white with subtle divider */}
      ...
      {/* Community Impact – softer cards, better spacing */}
      <section className="bg-gradient-to-b from-slate-50 to-white py-20 sm:py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="text-center mb-14 sm:mb-16 lg:mb-20">
            <h2
              className="text-4xl sm:text-5xl lg:text-6xl font-extrabold bg-gradient-to-r from-indigo-600 via-violet-600 to-purple-600 bg-clip-text text-transparent mb-4"
              data-aos="zoom-in"
              data-aos-delay="150"
            >
              Community at a Glance
            </h2>
            <p className="text-lg sm:text-xl text-slate-600 max-w-3xl mx-auto" data-aos="fade-up" data-aos-delay="250">
              Real impact created by students, for students
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 lg:gap-8">
            {[
              ...
              { number: "50K+", label: "Students Reached", icon: Users },
              { number: "120K+", label: "Saves & Shares", icon: HeartPulse },
              { number: "8K+", label: "Active Creators", icon: Trophy },
            ].map((stat, i) => (
              <div
                key={i}
                className="group bg-white/80 backdrop-blur-sm border border-slate-100 rounded-2xl p-6 sm:p-8 text-center hover:shadow-xl hover:shadow-indigo-100/60 transition-all duration-400 hover:-translate-y-2"
                data-aos="fade-up"
                data-aos-delay={`${i * 120 + 200}`}
              >
                <div className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-indigo-50 text-indigo-600 mb-5 group-hover:bg-indigo-100 transition-colors">
      ...
      {/* Explore Topics – softer, larger icons, glass effect */}
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {[
              ...
              <div
                key={i}
                className={`group bg-gradient-to-br from-white to-slate-50/80 border border-slate-100 rounded-2xl sm:rounded-3xl p-8 sm:p-10 text-center hover:shadow-2xl hover:shadow-${cat.color}-100/40 hover:border-${cat.color}-200 transition-all duration-400 hover:-translate-y-3`}
                data-aos="zoom-in-up"
                data-aos-delay={`${i * 120 + 250}`}
              >
                <div className={`inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-${cat.color}-50 text-${cat.color}-600 mb-6 group-hover:scale-110 transition-transform`}>
      ...
      {/* Most Saved Lessons */}
      <section className="py-20 sm:py-24 lg:py-32 bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {[
              ...
              <div
                key={i}
                className="bg-gradient-to-br from-white to-slate-50/80 border border-slate-100 rounded-2xl sm:rounded-3xl p-6 sm:p-8 hover:shadow-xl hover:shadow-indigo-100/40 transition-all duration-400 hover:-translate-y-2"
                data-aos="fade-up"
              ...
              >
                <div className="flex items-center gap-4 mb-5 sm:mb-6">
                  <img
                    src={t.avatar}
                    alt={t.name}
                    className="w-14 h-14 sm:w-16 sm:h-16 rounded-full object-cover ring-2 ring-indigo-100"
                  />
      ...
      <section className="py-20 sm:py-24 lg:py-32 bg-white border-t border-slate-100">
        <div className="max-w-4xl mx-auto px-5 sm:px-6 text-center">
          ...
          <p className="text-lg sm:text-xl text-slate-600 mb-10 sm:mb-12 max-w-3xl mx-auto">
            Get fresh student life wisdom, new lessons and early access updates delivered straight to your inbox.
          </p>

          <form className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto" data-aos="fade-up" data-aos-delay="300">
            <input
              type="email"
      ...
      {/* Premium CTA – more dramatic, centered, luxurious */}
      <section className="relative py-24 sm:py-32 lg:py-40 overflow-hidden bg-gradient-to-br from-indigo-950 via-violet-950 to-purple-950 text-white">
        ...
        <div className="absolute inset-0 opacity-[0.07]">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_70%,#ffffff_0.8px,transparent_1px)] [background-size:24px_24px]"></div>
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-5 sm:px-6 text-center">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl mb-10 sm:mb-14 opacity-90 max-w-4xl mx-auto leading-relaxed" data-aos="fade-up" data-aos-delay="400">
            Unlock premium lessons • ad-free reading • lifetime access • exclusive content
          </p>

          <Link to="/pricing">
            <button
              className="group relative inline-flex flex-col sm:flex-row items-center gap-5 sm:gap-8 bg-white text-indigo-950 px-10 sm:px-14 lg:px-20 py-6 sm:py-8 rounded-3xl text-2xl sm:text-3xl lg:text-4xl font-extrabold shadow-2xl hover:shadow-3xl hover:shadow-indigo-600/40 transition-all duration-700 hover:scale-[1.04] sm:hover:scale-110 w-full sm:w-auto"
              data-aos="zoom-in"
              data-aos-delay="600"
            >
              ...
              <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Upgrade to Premium</span>
