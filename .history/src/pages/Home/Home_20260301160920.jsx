...
const Home = () => {
  return (
    <div className="bg-gradient-to-b from-slate-50 to-white min-h-screen">
      ...
      {/* 2. Featured Lessons – added top padding to prevent overlap with fixed navbar */}
      <section
        className="
          relative 
          -mt-16 sm:-mt-20 lg:-mt-24           // keeps some overlap/lift effect
          pt-28 sm:pt-32 lg:pt-40              // ← this is the key fix: enough space below navbar
      ...
      <section
        className="bg-white py-20 sm:py-24 lg:py-32 border-t border-slate-100"
        data-aos="fade-up"
        data-aos-delay="400"
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
      ...
      {/* 4. Community Impact */}
      <section
        className="py-20 sm:py-24 lg:py-32 bg-gradient-to-b from-slate-50/80 to-white"
        data-aos="fade-up"
        data-aos-delay="500"
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
      ...
      {/* 5. Explore Topics */}
      <section
        className="py-20 sm:py-24 lg:py-32 bg-white border-t border-b border-slate-100"
        data-aos="fade-up"
        data-aos-delay="600"
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
      ...
      {/* Most Saved Lessons */}
      <section
        className="py-20 sm:py-24 lg:py-32 bg-gradient-to-b from-white to-slate-50/50"
        data-aos="fade-up"
        data-aos-delay="700"
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
      ...
      {/* Top Contributors */}
      <section
        className="py-20 sm:py-24 lg:py-32 bg-gradient-to-b from-slate-50/50 to-white"
        data-aos="fade-up"
        data-aos-delay="900"
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
