...
const Home = () => {
  return (
    <div className="bg-base-100 min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 lg:gap-8">
            {[
              ...
              <div
                key={i}
                className={`group bg-base-100 border border-base-300 rounded-xl sm:rounded-2xl p-5 sm:p-7 text-center hover:shadow-lg hover:shadow-${stat.color}-100/40 transition-all duration-300 hover:-translate-y-2`}
                data-aos="fade-up"
              ...
              >
                ...
                <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-base-content mb-1">
                  {stat.number}
                </h3>
                <p className="text-base-content/70 text-sm sm:text-base">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* 5. Explore Topics */}
      <section
        className="py-16 sm:py-20 lg:py-24 bg-base-100 border-t border-b border-base-300"
        data-aos="fade-up"
        data-aos-delay="500"
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <h2
            className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-center mb-10 sm:mb-12 lg:mb-14 bg-gradient-to-r from-base-content to-base-content/80 bg-clip-text text-transparent"
            data-aos="fade-down"
            data-aos-delay="200"
          >
            Explore by Topic
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 lg:gap-8">
            {[
              ...
              <div
                key={i}
                className={`group bg-base-100/80 backdrop-blur-sm border border-base-300 rounded-xl sm:rounded-2xl p-6 sm:p-8 text-center hover:shadow-xl hover:shadow-${cat.color}-100/30 hover:border-${cat.color}-200 transition-all duration-300 hover:-translate-y-2`}
                data-aos="zoom-in-up"
              ...
              >
                ...
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-base-content group-hover:text-base-content transition-colors">
                  {cat.title}
                </h3>
              </div>
            ))}
      ...
      {/* Testimonials */}
      <section
        className="py-16 sm:py-20 lg:py-24 bg-base-100 border-t border-base-300"
        data-aos="fade-up"
        data-aos-delay="700"
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {[
              ...
              <div
                key={i}
                className="bg-base-100 border border-base-300 rounded-xl sm:rounded-2xl p-6 sm:p-8 hover:shadow-lg hover:shadow-primary/30 transition-all duration-300 hover:-translate-y-1.5"
                data-aos="fade-up"
              ...
              >
                <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-5">
                  <img
                    src={t.avatar}
                    alt={t.name}
                    className="w-12 h-12 sm:w-14 sm:h-14 rounded-full object-cover ring-2 ring-primary/20 shadow-sm"
                  />
                  <h4 className="text-base sm:text-lg font-semibold text-base-content">{t.name}</h4>
                </div>
                <p className="text-base-content/70 italic leading-relaxed text-sm sm:text-base">
                  “{t.quote}”
                </p>
              </div>
            ))}
      ...
      >
        <div className="max-w-4xl mx-auto px-5 sm:px-6 text-center">
          <h2
            className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-5 bg-gradient-to-r from-base-content to-base-content/80 bg-clip-text text-transparent"
            data-aos="zoom-in"
            data-aos-delay="200"
          >
          ...
          <p className="text-base sm:text-lg text-base-content/70 mb-8 sm:mb-10 max-w-3xl mx-auto">
          ...
          >
            <input
              ...
              className="flex-1 px-5 sm:px-6 py-3 sm:py-4 rounded-xl border border-base-300 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition shadow-sm text-base bg-base-100"
              required
            />
            <button
              type="submit"
              className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-primary to-secondary hover:from-primary-focus hover:to-secondary-focus text-primary-content rounded-xl font-semibold text-base sm:text-lg transition shadow-md flex items-center justify-center gap-2 hover:shadow-primary/30 hover:scale-[1.02]"
            >
          ...
          <p className="text-sm text-base-content/50 mt-5">We value your privacy • No spam • Ever.</p>
        </div>
      </section>
