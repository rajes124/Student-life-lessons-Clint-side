...
const PublicLessons = () => {
  ...
  return (
    <div className="min-h-screen bg-base-100 py-12 px-4 sm:px-8 lg:px-12 relative overflow-hidden">
      {/* Background Decor */}
      <div className="absolute top-0 right-0 w-72 h-72 sm:w-[500px] sm:h-[500px] bg-indigo-50/30 dark:bg-indigo-900 rounded-full blur-[120px] -z-10 opacity-60" />
      <div className="absolute bottom-0 left-0 w-64 h-64 sm:w-[400px] sm:h-[400px] bg-purple-50 rounded-full blur-[100px] -z-10 opacity-60" />
