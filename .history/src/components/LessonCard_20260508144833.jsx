...
const LessonCard = ({ lesson, isPremiumUser }) => {
  ...
  if (isPremiumLesson && !isPremiumUser) {
    return (
      <div className="relative group rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 bg-base-100">
        <img
  ...
  return (
    <div className="group relative bg-base-100 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden border border-base-300">
