                ...
                {profileOpen && (
                  <div className="absolute right-0 mt-4 w-80 bg-white dark:bg-gray-800 shadow-2xl rounded-xl p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
                    ...
                    <Link
                      ...
                      className="flex items-center gap-3 py-2 hover:text-indigo-600 dark:hover:text-indigo-400 font-medium transition"
                    >
                    ...
                    {userData?.role === "admin" && (
                      <Link
                        to="/dashboard/admin"
                        onClick={() => setProfileOpen(false)}
                        className="flex items-center gap-3 py-3 mt-2 bg-red-600 hover:bg-red-700 dark:bg-red-700 dark:hover:bg-red-800 text-white font-bold rounded-lg text-center transition justify-center"
                      >
                    ...
                    <button
                      ...
                      className="flex items-center gap-3 justify-center w-full mt-5 py-3 bg-red-600 hover:bg-red-700 dark:bg-red-700 dark:hover:bg-red-800 text-white font-bold rounded-lg transition"
                    >
            ...
            <>
              ...
              {userData?.role === "admin" && (
                <Link
                  to="/dashboard/admin"
                  onClick={() => setMobileOpen(false)}
                  className="flex items-center gap-3 py-4 text-xl font-bold text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/30 rounded-lg justify-center"
                >
