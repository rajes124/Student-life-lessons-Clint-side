...
const Navbar = () => {
  ...
  return (
    ...
    >
        ...
        <div className="hidden md:flex items-center gap-5 lg:gap-7 xl:gap-8">
          {currentUser ? (
              ...
              <div className="relative">
                ...
                <div
                  className={`
                    ...
                    bg-base-100/95 backdrop-blur-lg shadow-2xl rounded-2xl p-6 border border-base-300/50
                ...
                >
                  <div className="text-center mb-6">
                    ...
                    />
                    <p className="font-bold text-xl text-base-content truncate">
                  ...
                  <hr className="my-5 border-base-300/70" />

                  <div className="space-y-2">
                    <Link
                      to="/dashboard"
                      onClick={() => setProfileOpen(false)}
                      className="flex items-center gap-3 py-2.5 px-4 rounded-xl hover:bg-base-200 hover:text-primary transition-all duration-200 font-medium"
                    >
                    ...
                    <Link
                      ...
                      onClick={() => setProfileOpen(false)}
                      className="flex items-center gap-3 py-2.5 px-4 rounded-xl hover:bg-base-200 hover:text-primary transition-all duration-200"
                    >
            ...
            <>
              <NavLink
                to="/login"
                className="flex items-center gap-2 text-base-content hover:text-primary transition-all duration-300 hover:scale-105"
              >
      ...
      <div
        className={`
          md:hidden bg-base-100/95 backdrop-blur-lg border-t border-base-300/50 shadow-2xl
