...
import {
  ...
  ChevronDown,
  Sparkles,
  ShieldCheck,  // Admin Panel-এর জন্য
} from "lucide-react";
          ...
          {currentUser ? (
            <>
              ...
              <div className="relative">
                ...
                {profileOpen && (
                  <div className="absolute right-0 mt-4 w-80 bg-white shadow-2xl rounded-xl p-6 border border-gray-200">
                    ...
                    {userData?.role === "admin" && (
                      <Link
                        to="/dashboard/admin"
                        onClick={() => setProfileOpen(false)}
                        className="flex items-center gap-3 py-3 mt-2 bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg text-center transition justify-center shadow-md"
                      >
                    ...
                    <button
                      ...
                      className="flex items-center gap-3 justify-center w-full mt-5 py-3 bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg transition shadow-md"
                    >
            ...
            <>
              ...
              {userData?.role === "admin" && (
                <Link
                  to="/dashboard/admin"
                  onClick={() => setMobileOpen(false)}
                  className="flex items-center gap-3 py-4 text-xl font-bold text-red-600 bg-red-50 rounded-lg justify-center shadow-md"
                >
