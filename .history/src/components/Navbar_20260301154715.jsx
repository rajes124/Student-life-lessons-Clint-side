  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        {/* Center Menu - Tablet & Desktop (Dashboard removed) */}
        ...
        <div className="hidden md:flex items-center gap-6 lg:gap-8">
          {currentUser ? (
            <>
              {/* Profile Dropdown – animated (Dashboard moved here) */}
              <div className="relative">
                ...
                {/* Dropdown with animation – Dashboard now inside */}
                <div
                  className={`
      ...
      {/* Mobile Menu – slide from top with stagger (Dashboard moved inside profile area) */}
      <div
        className={`
        ...
        <div className="px-5 sm:px-8 py-6 space-y-3">
          {currentUser ? (
            <>
              ...
              {/* Profile section in mobile – acts like dropdown content */}
              <div className="mt-4 pt-4 border-t border-gray-200">
                <div className="flex items-center gap-4 px-5 py-3 bg-indigo-50/50 rounded-xl mb-3">
                  <img
                    src={currentUser.photoURL || "https://i.ibb.co/9yK7qfM/user.png"}
                    alt="profile"
                    className="w-12 h-12 rounded-full border-4 border-indigo-400 object-cover"
                  />
                  <div>
                ...
                <button
                  onClick={handleLogout}
                  className="flex items-center gap-4 py-3.5 px-5 w-full text-left text-red-700 hover:bg-red-50 rounded-xl text-lg font-bold transition-all duration-300 mt-2"
                >
