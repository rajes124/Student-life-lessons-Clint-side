...
const Footer = () => {
  return (
    <footer className="relative bg-base-content text-base-100 pt-16 pb-12 mt-24 overflow-hidden">
      {/* Animated background glow */}
      <div className="absolute inset-0 bg-gradient-to-br from-base-content/30 via-secondary/20 to-base-content pointer-events-none">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
        ...
        <div className="space-y-5 animate-fade-in-up">
          ...
          <p className="text-base-100/80 leading-relaxed text-base sm:text-lg">
            Preserve wisdom.<br />
            Grow together.<br />
            Learn for life.
          </p>
        ...
        <div className="animate-fade-in-up animation-delay-100">
          ...
          <ul className="space-y-3.5 text-base-100/80">
            {[
              { to: "/", label: "Home" },
              ...
              >
                <Link
                  to={item.to}
                  className="group flex items-center gap-2.5 text-base hover:text-warning transition-all duration-300 hover:translate-x-2 hover:font-medium"
                >
                  <span className="w-1.5 h-1.5 rounded-full bg-primary/60 group-hover:bg-warning transition-colors"></span>
                  {item.label}
                </Link>
              </li>
            ))}
        ...
        <div className="animate-fade-in-up animation-delay-200 space-y-5">
          ...
          <div className="space-y-4 text-base-100/80 text-base">
            {[
              ...
              <a
                key={item.text}
                href={item.href}
                className="flex items-start gap-3 hover:text-warning transition-all duration-300 group"
                style={{ animationDelay: `${300 + i * 100}ms` }}
              >
                <item.icon className="w-5 h-5 mt-0.5 flex-shrink-0 text-primary group-hover:text-warning transition-colors" />
          ...
          <div className="flex flex-wrap gap-6">
            {[
              ...
              <a
                ...
                className="text-3xl hover:text-warning transition-all duration-300 hover:scale-125 hover:-translate-y-1 active:scale-110"
      ...
      <div className="relative mt-16 mx-auto max-w-5xl h-px bg-gradient-to-r from-transparent via-primary/30 to-transparent"></div>

      {/* Bottom Bar */}
      <div className="relative mt-8 text-center text-base-100/70 text-sm flex flex-col sm:flex-row justify-center items-center gap-3 px-6">
