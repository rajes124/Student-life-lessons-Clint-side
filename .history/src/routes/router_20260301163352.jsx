...
import UpdateLesson from "../dashboard/user/UpdateLesson";

// নতুন ইমপোর্ট (শুধু এটাই যোগ করা হয়েছে)
import Topics from "../pages/Topics";   // ← আপনার Topics পেজের লোকেশন অনুযায়ী পাথ ঠিক করুন
...
export const router = createBrowserRouter([
  // Public Routes (with RootLayout - Navbar + Footer)
  {
    ...
    children: [
      ...
      // নতুন রাউট যোগ করা হয়েছে (এটাই একমাত্র পরিবর্তন)
      { path: "topics/:slug", element: <Topics /> },
    ],
  },
